...
`
const StyledBadge = styled(LocalOfferRoundedIcon)`
    margin-right: 10px;
    color: #00CC00;
    font-size: 15px;
`;
      ...
      <Typography>{product.title.longTitle}</Typography>
        ...
        <Typography>Available offers</Typography>
            <SmallText>
                ...
                <Typography><StyledBadge /> Extra ₹1250 off on HDFC Bank Credit Card (inc.EMI) and Debit EMI on order value of ₹49,999 and above</Typography>
                <Typography><StyledBadge /> Flat INR 100 Instant Discount on transactions made through HDFC Internet Banking</Typography>
            </SmallText>
            <Table>
                <TableBody>
                    <ColumnText>
